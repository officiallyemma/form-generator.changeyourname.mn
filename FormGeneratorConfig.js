...
let Config = {
    ...
    onload: () => {
        document.querySelectorAll('#sexOnBirthRecords, #newSex').forEach((el) => el.addEventListener('change', (e) => {
            const sexOnBirthRecords = document.getElementById('sexOnBirthRecords');
