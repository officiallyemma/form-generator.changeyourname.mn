...
`,
    ...
    documents: [
        ...
        },
        {
            ...
            btnIcon: "security",
            inputFields: ["currentFirstName", "currentMiddleName", "currentLastName", "newFirstName", "newMiddleName", "newLastName", "dateOfBirth", "sexOnBirthRecords", "race", "legallyBindingSignature"],
            pdfFields: {
                name: "text",
                nickname: "text",
                dob: "text",
        ...
        },
        {
            ...
            btnIcon: "gavel",
            inputFields: ["currentFirstName", "currentMiddleName", "currentLastName", "address", "city", "state", "zip", "county", "dateOfBirth", "newFirstName", "newMiddleName", "newLastName", "newSex"],
            pdfFields: {
                name: "text",
                newName: "text",
                fullAddress: "text",
